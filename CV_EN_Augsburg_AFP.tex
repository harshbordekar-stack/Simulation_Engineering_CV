...
Composite research and simulation engineer with 7+ years of experience in CFRP materials, high-fidelity FEM (ABAQUS), and thermal and structural simulation of aerospace-relevant structures. My PhD at DLR \& TU Braunschweig builds a data-driven multiscale simulation framework for AFP-processed CFRP: using microscopy-derived microstructure data, it captures AFP-induced manufacturing nonlinearities and defects and propagates their effect from ply and laminate to structural scale, extending to leakage prediction in AFP-manufactured hydrogen pressure tanks. This gives me a strong working knowledge of how AFP process features and manufacturing variability translate into simulation, alongside evaluating material systems and effective properties, quantifying defects (fibre waviness, porosity) from image and CT data, and running large-scale thermal and structural simulations on HPC. I work within collaborative, publicly-funded research and technology-development (TRL) settings, interfacing with partner institutes, coordinating student work, and documenting results to aerospace reporting standards, with Python-based automation of simulation and post-processing workflows.

\vspace{0.2cm}
\textbf{Core Competencies:} AFP-Processed CFRP (manufacturing-feature modelling in simulation), CFRP \& Composite Materials, Thermal \& Structural Simulation (ABAQUS/ABAQUS CAE), Data-Driven Multiscale / Homogenization, Manufacturing-Induced Defect \& Quality Analysis, Material System \& Technology Evaluation, Non-linear \& Damage Modelling, Research-Project Work-Package Contribution, Technology Development (TRL), Aerospace-Standard Documentation, Python Automation, HPC (SLURM). \textit{Familiar with AFP process fundamentals; developing hands-on AFP-machine and CATIA composite-design experience.}
...
\resumeSubheading
    ...
    \resumeItemListStart
    \item (PhD) Developed a data-driven, microstructure-informed multiscale framework for \textbf{AFP-processed CFRP}, using microscopy-derived microstructure data to capture AFP-induced manufacturing nonlinearities and defects in simulation and propagate their effect from ply and laminate to structural scale, extending to leakage prediction in AFP-manufactured hydrogen pressure tanks.
\\
\textbf{Tools: Git, Docker, Python, ABAQUS, FEM, HPC/SLURM, microscopy data}
...
\noindent\parbox{\textwidth}{\textbf{Focus:} Numerical Methods, CFRP Modeling using State-of-the-Art Failure Models,\\ Scientific Machine Learning, Deep Learning}
\vspace{4pt}

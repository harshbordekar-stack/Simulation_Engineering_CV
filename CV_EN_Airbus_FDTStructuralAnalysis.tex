...
% Resume Template
% Author : Harsh
% Tailored for: Airbus Operations GmbH -- "F&DT Structural Analysis Engineer
% (d/f/m)", Hamburg (posting JR10421829, entry-level/"Anfaenger")
%
...
%        month/year.
%  - Honest gap: the posting names A350XWB and A320 Family specifically.
%        Harsh has no experience on those or any other in-service Airbus
%        aircraft programs -- his structural analysis work is on hydrogen
%        storage tanks, the Callisto rocket housing, and AM titanium parts.
%        Not claimed anywhere in this CV; named directly in the cover
%        letter's transparency paragraph.
%  - Honest gap: the posting lists ISAMI and HSB as named analytical/
%        calculation methods alongside Niu and Bruhn. Harsh has used Niu and
%        Bruhn only -- ISAMI and HSB are deliberately not listed anywhere.
%  - Honest gap: "define structural tests for certification" (i.e. physical
%        test campaigns) is not something Harsh has done. His closest real
%        match is coupling defect measurements with numerical simulation to
%        set qualification/acceptance criteria -- kept as that, not
%        reworded into test definition.
%------------------------
...
\begin{center}
    ...
    \textbf{F\&DT Structural Analysis Engineer (d/f/m)} \\
    \textbf{PhD Candidate at DLR \& TU Braunschweig, expected \textbf{[x]}} \\
    \textbf{Structural Analysis \& F\&DT: Metallic \& Composite, Model V\&V, Simulation Automation}
...
Structural analysis and simulation engineer with 7+ years of experience in aerospace structural integrity, spanning fatigue and damage tolerance (F\&DT) of metallic structures and progressive damage of composites. Builds and validates structural analysis models and calculations against defined methods, produces the supporting analysis documentation, and provides sign-off-style technical review of externally and student-produced analysis work, meshes, and results, communicating findings to design and project teams. Experience includes deriving certification-aligned failure criteria and allowable defect/damage limits (Murakami, El-Haddad small-defect models) consistent with regulatory boundary conditions, alongside high-fidelity linear and non-linear FEM, model verification \& validation, and stochastic/uncertainty analysis for certification-oriented sizing. Currently a PhD Candidate at DLR \& TU Braunschweig. Familiar with analytical stress methods (Niu, Bruhn) alongside FE solvers (Nastran/Patran, ABAQUS), with a strong record of driving digital transformation through process automation: Python- and HPC-based automation of analysis and reporting workflows, and an agentic AI application for on-demand property prediction that removes the need for full-scale FEM runs.

\vspace{0.2cm}
\textbf{Core Competencies:} Fatigue \& Damage Tolerance (F\&DT), Structural Analysis Models \& Calculations, Analysis Documentation \& Technical Review, Fatigue Life \& Allowable Defect Size (Murakami, El-Haddad), Metallic \& Composite Structural Analysis, Linear \& Non-linear FEM (Nastran/Patran, ABAQUS), Analytical Stress Methods (Niu, Bruhn), Verification \& Validation, Certification-Oriented Sizing \& Regulatory Compliance, Simulation \& Reporting Automation, Uncertainty Quantification (UQ), Python Programming, HPC (SLURM)
...
\resumeSubheading
    ...
    {Analysis models, technical review \& digital-transformation automation}{Feb $2021$ - Present}
    \resumeItemListStart
...
\item Evaluated thermal protection effectiveness for the Callisto reusable rocket program's metal upper housing bay, building structural analysis models and executing large-scale thermal and structural simulations on HPC infrastructure.
\\
...
\resumeSubheading
    ...
    {Fatigue-life / defect-tolerance assessment}{Nov $2019$ - Jan $2021$}
\resumeItemListStart

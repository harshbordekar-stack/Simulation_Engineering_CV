...
% Resume Template
% Author : Harsh
% Tailored for: Airbus Operations GmbH -- "Fatigue & Damage Tolerance Engineer
% (d/f/m)", Hamburg (posting JR10416220)
%
...
%        month/year.
%  - Honest note, not a gap needing a placeholder: this posting is pitched as
%        entry-level / "first experience in F&DT" and Harsh has 7+ years,
%        which is a strength here, not a mismatch, so nothing was downplayed.
%  - Honest gap: "stress analysis for the repair/acceptance of damaged
%        structures" is mapped to his real defect-tolerance qualification and
%        allowable-defect-acceptance-limit work, a genuine match for the
%        "acceptance" half. He has not designed or validated physical repair
%        schemes; that is not claimed anywhere in this CV.
...
\begin{center}
    ...
    \textbf{Fatigue \& Damage Tolerance Engineer (d/f/m)} \\
    \textbf{PhD Candidate at DLR \& TU Braunschweig, expected \textbf{[x]}} \\
    \textbf{Fatigue \& Damage Tolerance: Composite \& Hybrid Structures, Metallic Structures, Model V\&V}
...
Structural analysis and simulation engineer with 7+ years of experience in aerospace structural integrity, spanning fatigue and damage tolerance (F\&DT) of composite and hybrid structures alongside metallic structures. Experience includes analyzing and validating structures against defined F\&DT methods: deriving allowable defect/damage limits for a target fatigue life using small-defect fatigue models (Murakami, El-Haddad) and certification-aligned failure criteria, coupling defect measurements with numerical simulation to establish acceptance limits for damaged or defective structures, and validating theoretical damage models against measured data. This sits alongside high-fidelity linear and non-linear FEM, progressive damage analysis of composites (CDM, PDA, CZM), model verification \& validation, and stochastic/uncertainty analysis for certification-oriented sizing. Currently a PhD Candidate at DLR \& TU Braunschweig, developing a certification-aligned damage/leakage failure criterion that translates multiscale damage models into structural sizing inputs consistent with regulatory boundary conditions. Regularly collaborates across design, materials, and stress interfaces: reviewing externally and student-produced structural analysis work, defining technical scope for that work, and communicating findings to design and project teams. Familiar with analytical stress methods (Niu, Bruhn) alongside FE solvers (Nastran/Patran, ABAQUS), with a strong record of process automation using Python and HPC pipelines and an active interest in applying AI to improve analysis workflows.

\vspace{0.2cm}
\textbf{Core Competencies:} Fatigue \& Damage Tolerance (F\&DT), Composite \& Hybrid Structures, Damage/Defect Acceptance Limits, Fatigue Life \& Allowable Defect Size (Murakami, El-Haddad), Metallic \& Composite Structural Analysis, Linear \& Non-linear FEM (Nastran/Patran, ABAQUS), Progressive Damage Analysis (CDM, PDA, CZM), Analytical Stress Methods (Niu, Bruhn), Verification \& Validation, Certification-Oriented Sizing, Simulation \& Reporting Automation, Uncertainty Quantification (UQ), Python Programming, HPC (SLURM)
...
\resumeSubheading
    ...
    {Composite F\&DT, damage acceptance limits \& validated-method sizing}{Feb $2021$ - Present}
    \resumeItemListStart
    \item (PhD) Derived a certification-aligned leakage failure criterion (leakage envelope) that maps combined strain/load states to leakage onset, defining an allowable-damage-limit philosophy per validated methods, and translating multiscale FEM outputs into structural sizing inputs consistent with regulatory boundary conditions, providing the failure-criterion definition and stress justification required for structural approval.
\\
...
\item Performed uncertainty quantification to generate leakage probability vs. strain relationships, validating theoretical damage models against measured/simulated data and enabling risk-informed design decisions for next-generation CFRP pressure vessels under hydrogen storage conditions.
\\
\textbf{Tools: Python (scipy, numpy), Monte Carlo methods, ABAQUS}

\item Verified and technically reviewed externally and student-produced analysis models, meshes, and simulation results against defined methods and acceptance criteria, providing sign-off-style checks on structural analysis data and documentation and communicating findings to design and project teams.
\\
...
\resumeSubheading
    ...
    {Damage/defect acceptance limits \& fatigue-life qualification}{Nov $2019$ - Jan $2021$}
\resumeItemListStart
    \item Coupled defect measurements with numerical simulation to establish a defect-tolerance qualification methodology, translating fracture-mechanics and fatigue criteria into allowable-defect acceptance limits for manufactured metallic parts, providing the stress-analysis basis for accepting or rejecting defective structures.
    \\
...
Composite \& hybrid structures F\&DT \(\vert\) Fatigue-life assessment \(\vert\) Allowable defect/damage size (Murakami, El-Haddad) \(\vert\) Damage/defect acceptance limits \(\vert\) Certification concepts \\

...
\begin{center}
    ...
    \textbf{Stress \& F\&DT Engineer | PhD Candidate at DLR \& TU Braunschweig} \\
    \textbf{Aircraft Structural Analysis --- Fatigue \& Damage Tolerance, Metallic \& Composite}
...
Structural analysis and simulation engineer with 7+ years of experience in aerospace structural integrity, spanning fatigue and damage tolerance (F\&DT) of metallic structures and progressive damage of composites. Experience covers fatigue-life and crack-growth assessment (Paris law, NASGRO, Murakami and El-Haddad defect models) to determine allowable defect sizes, as well as high-fidelity linear and non-linear FEM, model verification \& validation, and stochastic/uncertainty analysis for certification-oriented sizing. Currently a PhD Candidate at DLR \& TU Braunschweig, developing multiscale frameworks that translate damage models into structural sizing inputs consistent with regulatory boundary conditions. Comfortable with analytical stress methods (Niu, Bruhn) alongside FE solvers (Nastran/Patran, ABAQUS), and a strong record of process automation using Python and HPC pipelines to accelerate analysis and reporting. Experienced in guiding subcontracted/student technical work, verifying externally produced analyses, and communicating results to design and project teams.

\vspace{0.2cm}
\textbf{Core Competencies:} Fatigue \& Damage Tolerance (F\&DT), Crack Growth \& Fatigue Life (Paris/NASGRO), Allowable Defect Size (Murakami, El-Haddad), Metallic \& Composite Structural Analysis, Linear \& Non-linear FEM (Nastran/Patran, ABAQUS), Analytical Stress Methods (Niu, Bruhn), Verification \& Validation, Certification-Oriented Sizing, Airworthiness \& Damage Tolerance Concepts, Stress Approval of Analyses, Simulation \& Reporting Automation, Uncertainty Quantification (UQ), Python Programming, HPC (SLURM)
...
\resumeSubheading
    ...
    {Damage tolerance, structural sizing \& simulation automation}{Feb $2021$ - Present}
    \resumeItemListStart
...
\item (PhD) Derived a certification-aligned leakage failure criterion (leakage envelope) that maps combined strain/load states to leakage onset, bridging progressive damage models and system-level tank simulations and translating multiscale FEM outputs into structural sizing inputs consistent with regulatory boundary conditions --- the type of failure-criterion definition and stress justification required for structural approval.
\\
...
\resumeItemListStart
    \item Performed fatigue and damage-tolerance assessment of aerospace-grade titanium (metallic) components, deriving allowable defect sizes for a target fatigue life using crack-growth (Paris law, NASGRO) and small-defect fatigue-limit models (Murakami, El-Haddad) --- directly linking as-built defect populations to structural fatigue substantiation.
    \\
    \textbf{Tools: Fatigue/crack-growth analysis (Paris, NASGRO, Murakami, El-Haddad), Python (NumPy/SciPy)}
...
Crack growth (Paris, NASGRO) \(\vert\) Allowable defect size (Murakami, El-Haddad) \(\vert\) Fatigue-life assessment \(\vert\) Damage tolerance \& certification concepts \\

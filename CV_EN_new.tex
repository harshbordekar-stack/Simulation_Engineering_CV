...
Structural analysis and simulation engineer with 7+ years of experience in aerospace structural integrity, spanning fatigue and damage tolerance (F\&DT) of metallic structures and progressive damage of composites. Experience includes fatigue-life and defect-tolerance assessment using small-defect fatigue models (Murakami, El-Haddad) to estimate allowable defect sizes for a target fatigue life, alongside high-fidelity linear and non-linear FEM, model verification \& validation, and stochastic/uncertainty analysis for certification-oriented sizing. Currently a PhD Candidate at DLR \& TU Braunschweig, developing multiscale frameworks that translate damage models into structural sizing inputs consistent with regulatory boundary conditions. Familiar with analytical stress methods (Niu, Bruhn) alongside FE solvers (Nastran/Patran, ABAQUS), with a strong record of process automation using Python and HPC pipelines to accelerate analysis and reporting. Experienced in guiding student and subcontracted technical work, verifying externally produced analyses, and communicating results to design and project teams.

\vspace{0.2cm}
\textbf{Core Competencies:} Fatigue \& Damage Tolerance (F\&DT), Fatigue Life \& Allowable Defect Size (Murakami, El-Haddad), Metallic \& Composite Structural Analysis, Linear \& Non-linear FEM (Nastran/Patran, ABAQUS), Analytical Stress Methods (Niu, Bruhn), Verification \& Validation, Certification-Oriented Sizing, Stress Approval of Analyses, Simulation \& Reporting Automation, Uncertainty Quantification (UQ), Python Programming, HPC (SLURM)
